"""Custom ApexRL actor and critic networks for drone hovering."""
...
class DroneActor(ContinuousActor):
    """Continuous Gaussian policy for the drone hover observation."""
...
class DroneCritic(Critic):
    """Value function network for drone hovering."""
